#Control Pessoa
from ModelPessoa import ModelPessoa   #from(Da classe: ) import(Utiliza a outra classe: "")
class ControlPessoa:
    #Método construtor
    def __init__(self):
    ...
    def cadastrar(self):
        ...
        #Pega a variavel pessoaUm(representa apenas uma pessoa) e relaciona com a Model
        #se quiser cadastrar uma segunda pessoa deverá criar a variável pessoaDois e etc.
    ...
    def menuAtualizar(self):
        ...
        self.atu = int(input())  #Variável que valida a opção escolhida (Qual o usuario escolheu)

    def atualizar(self):
        self.menuAtualizar()
        if self.atu == 1:
            nome = input("Informe o novo nome: ")
            self.pessoaUm.atualizarPessoa(self,self.atu,nome)  #Pega a variavel
        elif self.atu == 2:
